...
$product_name = "STEINS;GATE 0 Improvement Patch (Steam)"
...
New-Item -ItemType directory -Path ".\DIST\GATE 0" | Out-Null
# TODO how does wine handle this?
Move-Item .\DIST\dinput8.dll ".\DIST\GATE 0\"
...
Copy-Item .\DIST\VSFilter.dll ".\DIST\GATE 0\"
...
Move-Item -Force .\FONT_B.dds ..\..\temp\FONT_B.dds
...
#.\SciAdv.Net\bin\Release\Tools\SC3Tools\sc3tools.exe replace-text -o temp\patched_edited_script_archive temp\patched_script_archive\*.scx zero-scripts\*.txt steinsgate0
...
.\sc3tools\target\release\sc3tools.exe replace-text temp\patched_edited_script_archive\*.scx zero-scripts\*.txt steinsgate0
...
# DXVK
Move-Item .\DIST\d3d9 ".\DIST\GATE 0"
Move-Item .\DIST\d3d10 ".\DIST\GATE 0"
Move-Item .\DIST\d3d10_1 ".\DIST\GATE 0"
Move-Item .\DIST\d3d10core ".\DIST\GATE 0"
Move-Item .\DIST\d3d11 ".\DIST\GATE 0"
Move-Item .\DIST\dxgi ".\DIST\GATE 0"
...
PrintSection "Packing installer"
cd temp
$patchFolderName = "SG0Patch-v$version_string-Setup"
New-Item -ItemType directory -Path $patchFolderName | Out-Null
cd $patchFolderName
New-Item -ItemType directory -Path DIST | Out-Null
Move-Item -Force ..\..\DIST\* .\DIST
Copy-Item ..\..\laa_patch.vcdiff .\laa_patch.vcdiff
Move-Item -Force ..\..\installer\deploy\* .
Move-Item -Force .\noidget.exe .\SG0Patch-Installer.exe
cd ..\..\DIST
